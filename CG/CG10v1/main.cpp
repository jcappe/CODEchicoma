...
int main()
{
    ...
    //double box[8] = {-100.0, -100.0, -100.0, -100.0, 100.0, 100.0, 100.0, 100.0};   // max(x,y,z), min(x,y,z)
    double box[8] = {-20.0, -20.0, -20.0, -20.0, 20.0, 20.0, 20.0, 20.0};   // max(x,y,z), min(x,y,z)
    double distlim[8];
    ...
    double x[4] = {-1.0, 1.0, 2.0, -3.0};   // INITIAL GUESS
