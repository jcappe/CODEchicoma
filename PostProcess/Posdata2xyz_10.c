...
// OUTPUT FILE WRITTEN WITH FORMATTED INTEGERS AND STRINGS
...
// open new and write the modified output file
    ...
    char testchar[11] = "1234567890";
    fwrite(testchar,1,10,xyz);
    char testchar2[11] = "\nHELLO!";
    fwrite(testchar2,1,6,xyz);

    char wtemp[10];
    sprintf(wtemp,"%d",Ntot);
    printf("%s\n",wtemp);

    fwrite(wtemp,1,2,xyz);
    fclose(xyz);
